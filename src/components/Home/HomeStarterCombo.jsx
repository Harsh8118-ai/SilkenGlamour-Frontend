                ...
                <div className="sm:w-[70%] mx-2 sm:mx-auto my-8 bg-BGColorYellow mt-4 rounded-xl h-full">
                    <div className={`w-full h-fit m-3 mx-auto`}>
                        <div className="w-full sticky top-0.5 sm:top-8 flex flex-col justify-center items-center h-fit">
                            ...
                            <p className='text-2xl font-Helvetica font-semibold text-center mt-8 mb-16'>Discover Your Perfect Look with Our Variety of Lash Styles in the <br />Starter Pack!</p>
                            <div className="space-x-4 text-center">
                                <button
                                    className={`px-4 py-1.5 ${IsSelect ? "bg-MainBGColorYellow" : "bg-gray-400"} ${IsSelect ? "border-2" : "border-none"} border-black text-white rounded-full z-50`}
                                    onClick={() => {
                                ...
                                <button
                                    className={`px-4 py-1.5 ${IsSelect2 ? "bg-MainBGColorYellow" : "bg-gray-400"} ${IsSelect2 ? "border-2" : "border-none"} border-black text-white rounded-full`}
                                    onClick={() => {
...
export default HomeStarterCombo;
