            ...
            <div className="hidden sm:block fixed bottom-20 left-0 m-4 z-[999]">
                ...
                <div className="flex flex-row sm:flex-col space-x-4 sm:space-x-0 sm:space-y-4">
                    ...
                    <a
                        ...
                        className="bg-BGColorYellow rounded-full p-2 sm:p-3 shadow-lg hover:bg-[#635a4f] hover:text-white"
                        data-aos="fade-up"
                        data-aos-delay="100"
...
export default SocialMediaLinksService;
